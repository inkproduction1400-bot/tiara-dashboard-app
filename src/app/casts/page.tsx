...
function CastDetailModal({
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      howFound: sanitizeBackgroundField((detail.background as any)?.howFound ?? (detail.background as any)?.how_found ?? (detail.background as any)?.howfound),
      motivation: sanitizeBackgroundField((detail.background as any)?.motivation),
      otherAgencies: sanitizeBackgroundField((detail.background as any)?.otherAgencies ?? (detail.background as any)?.other_agencies ?? (detail.background as any)?.otheragencies),
