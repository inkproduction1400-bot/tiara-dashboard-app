...
export function MobileBottomNav() {
  ...
  return (
    <nav className="tiara-mobile-card tiara-mobile-pill fixed bottom-4 left-1/2 z-40 flex w-[calc(100%-1.5rem)] max-w-[390px] -translate-x-1/2 items-center justify-around border px-2 py-2 backdrop-blur">
